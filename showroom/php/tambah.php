                        ...
                        <div class="card form-card">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="namaMobil" id="namaMobil" class="form-control" required value="<?= isset($tp['nama Mobil']) ? htmlspecialchars($tp['nama Mobil'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                </div>
                                <div class="mb-3">
                                    <label for="merkMobil" class="form-label">Merk Mobil</label>
                                    <input type="text" name="merkMobil" id="merkMobil" class="form-control" required value="<?= isset($tp['merk Mobil']) ? htmlspecialchars($tp['merk Mobil'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                </div>
                                <div class="mb-3">
                                    <label for="jenisBBM" class="form-label">Jenis BBM</label>
                                    <input type="text" name="jenisBBM" id="jenisBBM" class="form-control" required value="<?= isset($tp['jenis BBM']) ? htmlspecialchars($tp['jenis BBM'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                </div>
                                <div class="mb-3">
